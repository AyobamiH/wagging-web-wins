...
<nav aria-label="Social media" className="mt-2 flex items-center gap-3">
  <a
    ...
    title="TikTok"
    className="inline-flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground hover:text-yellow-500 hover:bg-yellow-200/30 focus:outline-none focus:ring-2 focus:ring-yellow-400/60 transition"
  >
    {/* If you already use lucide-react elsewhere: */}
  ...
  <a
    ...
    className="inline-flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground hover:text-yellow-500 hover:bg-yellow-200/30 focus:outline-none focus:ring-2 focus:ring-yellow-400/60 transition"
  >
    {/* import { Instagram } from "lucide-react" if preferred */}
  ...
  <a
    ...
    className="inline-flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground hover:text-yellow-500 hover:bg-yellow-200/30 focus:outline-none focus:ring-2 focus:ring-yellow-400/60 transition"
  >
    {/* import { Linkedin } from "lucide-react" if preferred */}
    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
