...
export default function FAQ() {
  ...
  path="/faq"
  // Use supported props instead of `robots` and `canonical`
  noIndex={hasQueryParam}                               // was robots: "noindex,follow" when query
  canonicalOverride={hasQueryParam ? canonicalUrl : undefined} // force canonical to /faq on search states
