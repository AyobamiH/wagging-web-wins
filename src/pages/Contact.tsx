      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        ...
        <form onSubmit={submit} className="mt-6 grid gap-4 sm:grid-cols-2" aria-label="Contact form">
          ...
          <div className="flex items-center gap-3 sm:col-span-2">
            <button type="submit" className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground px-4 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
              Send Message
            </button>
