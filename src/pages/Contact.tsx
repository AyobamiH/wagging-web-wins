...
/>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        ...
        <span  className="text-xs font-medium text-muted-foreground">Areas We Serve</span>
        <span className="text-xs font-medium text-muted-foreground">Northampton, Wellingborough, Kettering, Daventry, Towcester, Rushden, Corby, Milton Keynes, Banbury.</span>
        
        <h1 className="text-3xl font-bold tracking-tight"><span> Northampton, Wellingborough, Kettering, Daventry, Towcester, Rushden, Corby, Milton Keynes, Banbury. </span>Let's make your website your best employee.</h1>
